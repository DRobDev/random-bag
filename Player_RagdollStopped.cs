...
public class Player_RagdollStopped : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (transform.root.gameObject.GetComponent<Player_Generic_BaseClass>() == null)
            return;
       ...
       {
           transform.root.gameObject.GetComponent<Player_Generic_BaseClass>().RagDollStoppedEvent();   //fire ragdoll stopped event
